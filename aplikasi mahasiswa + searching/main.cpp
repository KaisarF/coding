...
garis(80);
cout << "nama:\tkaisarfauzan\nnpm:\t20081010142\nkelas:\tpemlan D081" << endl;
garis(80);
...
cout<< endl;
garis(80);
cout<<"metode yang digunakan untuk mencari?\n1. linear serach\n2. binary search\n" << endl;
cin >> pilihan;
cout << endl;
garis(80);
...
if(pilihan=='1'){
 cout << endl;
    ...
    cout << "masukkan nilai npm yang ingin dicari: "; cin >> cari;
    cout << endl;

    while(i<=r && ktm==0){
        m= (i+r)/2;
        cout << "data tengah: " << m << endl;
        if(ke[m].npm==cari){ktm=1;}
        else if(cari<ke[m].npm){
